...
public class ReadPropertyFile {
	...
	public static void main(String[] args) throws IOException{
		...
		String filePath = System.getProperty("user.dir") + "\\Property_Files\\SignupDetails.properties";
		System.out.println("Current Dir: " + filePath);
		// file location and filename
		// Absolute path
		FileInputStream fis = new FileInputStream(
				"D:\\Acceleration\\May_13_Workspace\\Selenium_Basic\\Property_Files\\SignupDetails.properties");
		// or
		FileInputStream fis1 = new FileInputStream(filePath);
		// or relative path
		FileInputStream fis2 = new FileInputStream(".\\Property_Files\\SignupDetails.properties");
